...
class CiReleaseTests(unittest.TestCase):
    ...
    def test_builder_is_dormant_bounded_and_assembles_twice(self) -> None:
        ...
        self.assertIn("docker buildx create --name", builder)
        self.assertIn("--driver docker-container", builder)
        self.assertIn("moby/buildkit@sha256:a461e7f0ce921972028acfbed628d45663d83e67ac1230722c2b34cf72760a0d", builder)
