...
export const VOICE_RUNTIME_PATH_BINDINGS = Object.freeze({
  ...
  VOICE_APPROVAL_SIGNING_KEY_HOST_FILE:
    '/etc/teleagent-voice/credentials/voice-approval-private.pem',
...
export const VOICE_RUNTIME_MIGRATION_GUIDANCE =
  'Provision the dedicated non-login teleagent-voice system user/group, set explicit ' +
  'VOICE_APP_UID/GID, and install the signer plus both SIP trunk credentials as ' +
